...
Pd_session_component &Target_child::Resources::init_pd(const char *label, Pd_root &pd_root)
{
	...
	Genode::log("Session capability in init_pd", pd_cap);
...
Cpu_session_component &Target_child::Resources::init_cpu(const char *label, Cpu_root &cpu_root)
{
	...
	Genode::log("Session capability in init_cpu", cpu_cap);
...
Ram_session_component &Target_child::Resources::init_ram(const char *label, Ram_root &ram_root)
{
	...
	Genode::log("Session capability in init_ram", ram_cap);
...
Irq_session_component &Target_child::Resources::init_irq(const char *label, Irq_root &irq_root)
{
	...
	Genode::log("Session capability in init_irq", irq_cap);
